...
// when not using session cookie, get user cookie and test if been set. 
// Session cookie is retrieved in main.inc.php and check server side if consent is given
